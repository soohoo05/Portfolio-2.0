      ...
      <div className={`wholeForm ${this.props.dark}`}>
        ...
        <div className="Links">
          ...
          <img className="logos" onClick={()=>window.open("https://medium.com/@tyler.soohoo")}width="40px" height="40px" src="https://cdn-images-1.medium.com/max/1600/1*emiGsBgJu2KHWyjluhKXQw.png" alt="medium" />
            ...
            <img className="logos" onClick={()=>window.open("https://www.linkedin.com/in/tyler-soo-hoo-937328125/")} width="40px" height="40px" alt="linkedin" src="https://upload.wikimedia.org/wikipedia/commons/c/ca/LinkedIn_logo_initials.png" />
            </div>
      ...
      <h1 className="Header">About Me</h1>
        <div className="aboutDiv">
          <p className="aboutParagraph">
            ...
            in HTML, CSS, SQL, Node.js and Java. I currently work for Trilogy Education
            where I am an Online teaching assistant. I work with students and assist them
